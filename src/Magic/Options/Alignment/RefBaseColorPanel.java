 ...
 * @author Huabin Hou
 */
public class RefBaseColorPanel extends javax.swing.JPanel {

    private MagicFrame trackFrame;
    private String[] base = {"A", "T", "C", "G", "N"};

    /** Creates new form ReadsColorPanel */
    public RefBaseColorPanel(MagicFrame parent) {
        trackFrame = parent;
        initComponents();
        ...
        try {
            ...
            for (int i = 0; i < base.length; i++) {
                ...
                if (base[i].equals("A") || base[i].equals("T") || base[i].equals("C") || base[i].equals("G") || base[i].equals("N")) {
                    Field upfield = cls.getField(base[i].toLowerCase() + "LightColor");
                    color = (Color) upfield.get(Log.instance().alignPara);
                   // //System.out.println("------ref color-----"+upfield.getName());
                } 
                    ...
                    public void mousePressed(java.awt.event.MouseEvent evt) {
                        ...
                        if (color != null) {
                            ...
                            if (selectBase.equals("A") || selectBase.equals("T") || selectBase.equals("C") || selectBase.equals("G") || selectBase.equals("N")) {
                                Field upfield = null;
                                try {
                                    upfield = cls.getField(selectBase.toLowerCase() + "LightColor");
