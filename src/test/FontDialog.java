package test;
  ...
  public   class   FontDialog   extends   JPanel   implements   ActionListener,ListSelectionListener{
          ...
          private   void   initOther(){
                  ...
                  demo=new   JLabel("demo千里冰封     ABCD   abcd",JLabel.CENTER);
          ...
          public   static   Font   showDialog(Frame   owner,String   title){
                  FontDialog   jf=new   FontDialog();
                  jf.initWindow(title);
                  return   jf.current;
          }
          public   static   void   main(String[]   args)   {
              //System.out.println(FontDialog.showDialog(null,"请选择"));
          }
  }